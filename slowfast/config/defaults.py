...
_C.TRAIN.LINEAR_PROB = False

_C.TRAIN.WAV_INPUT = False
...
_C.RESNET.NUM_BLOCK_FREQ_KERNEL =  [[3], [4], [6], [3]]

# Size of stride on different res stages.
_C.RESNET.FREQUENCY_STRIDES = [[1], [2], [2], [2]]

# Size of stride on different res stages.
_C.RESNET.TIME_STRIDES = [[1], [1], [1], [1]]

# Size of dilation on different res stages.
_C.RESNET.FREQUENCY_DILATIONS = [[1], [1], [1], [1]]

_C.RESNET.FREQ_KERNEL_SIZES = [[7], [3], [3], [3], [3]]

_C.RESNET.TEMP_KERNEL_SIZES = [[[5]], [[11]], [[11]], [[11]], [[11]]]
...
# -----------------------------------------------------------------------------
_C.SPEECHCOMMANDV2 = CfgNode()

_C.SPEECHCOMMANDV2.AUDIO_DATA_FILE = ""

_C.SPEECHCOMMANDV2.ANNOTATIONS_DIR = ""

_C.SPEECHCOMMANDV2.TRAIN_LIST = "SPEECH_CMD_V2_train.pkl"

_C.SPEECHCOMMANDV2.VAL_LIST = "SPEECH_CMD_V2_validation.pkl"

_C.SPEECHCOMMANDV2.TEST_LIST = "SPEECH_CMD_V2_test.pkl"

_C.SPEECHCOMMANDV2.TRAIN_PLUS_VAL = False

_C.SPEECHCOMMANDV2.TEST_SPLIT = "validation"

# -----------------------------------------------------------------------------
# URBANSOUND8K Dataset options
# -----------------------------------------------------------------------------
_C.URBANSOUND8K = CfgNode()

_C.URBANSOUND8K.AUDIO_DATA_FILE = ""

_C.URBANSOUND8K.ANNOTATIONS_DIR = ""

_C.URBANSOUND8K.TRAIN_LIST = "UrbanSound8K_train_except_fold1.pkl"

_C.URBANSOUND8K.VAL_LIST = "UrbanSound8K_valid_fold1.pkl"

_C.URBANSOUND8K.TEST_LIST = "UrbanSound8K_valid_fold1.pkl"

_C.URBANSOUND8K.TRAIN_PLUS_VAL = False

_C.URBANSOUND8K.TEST_SPLIT = "validation"

# -----------------------------------------------------------------------------
# EPIC-SOUND Dataset options
# -----------------------------------------------------------------------------
_C.EPICSOUND = CfgNode()

_C.EPICSOUND.AUDIO_DATA_FILE = ""

_C.EPICSOUND.ANNOTATIONS_DIR = ""

_C.EPICSOUND.TRAIN_LIST = "EPIC_Sounds_train.pkl"

_C.EPICSOUND.VAL_LIST = "EPIC_Sounds_validation.pkl"

_C.EPICSOUND.TEST_LIST = "EPIC_Sounds_validation.pkl"

_C.EPICSOUND.TRAIN_PLUS_VAL = False

_C.EPICSOUND.TEST_SPLIT = "validation"

# -----------------------------------------------------------------------------
# Nsynth Dataset options
# -----------------------------------------------------------------------------
_C.NSYNTH = CfgNode()

_C.NSYNTH.TRAIN_AUDIO_DATA_DIR = ""

_C.NSYNTH.VALID_AUDIO_DATA_DIR = ""

_C.NSYNTH.TEST_AUDIO_DATA_DIR = ""

_C.NSYNTH.ANNOTATIONS_DIR = ""

_C.NSYNTH.TRAIN_LIST = "Nsynth-train.pkl"

_C.NSYNTH.VAL_LIST = "Nsynth-valid.pkl"

_C.NSYNTH.TEST_LIST = "Nsynth-test.pkl"
...
_C.TENSORBOARD.CONFUSION_MATRIX.FIGSIZE = [50, 50]
...
_C.AUGMENTATION.AUG_METHOD = "normal"
