...
def train_epoch(
    ...
    elif cfg.BN.FREEZE_ALL:
        model.module.freeze_fn('bn_all_statistics') if cfg.NUM_GPUS > 1 else model.freeze_fn('bn_all_statistics')
...
def train(cfg):
    ...
    if cfg.BN.FREEZE:
        ...
        model.module.freeze_fn('bn_all_parameters') if cfg.NUM_GPUS > 1 else model.freeze_fn('bn_all_parameters')

    if cfg.TRAIN.LINEAR_PROB:
        print('Freeze Pretrained Backbone Network')
